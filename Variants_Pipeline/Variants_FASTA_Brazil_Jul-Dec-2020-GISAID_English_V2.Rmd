...
![FASTA file formatting: a text file containing a biological sequence.](/Users/gepolianochaves/Desktop/Gepoliano/ReComBio_Notebook_Preparation/Figures/FASTA.png)
...
# Store VariantList
if (!dir.exists("VariantList")) {
  dir.create("VariantList")
}
